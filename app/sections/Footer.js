...
export default function Footer() {
  return (
    <footer>
      <div className="h-[311px] w-[1180px] bg-gradient-to-tr -from-green -to-yellow rounded-3xl relative overflow-hidden flex justify-between mx-auto -mb-52">
        <div className="flex flex-col gap-12 pl-12 py-12">
          <p className="text-[32px] leading-[48px] text-white">
            Try KAISPE employee leave management app and reduce paperwork
          </p>
          <div>
            <Link
              href="https://outlook.office365.com/book/KAISPE6@NETORGFT2992819.onmicrosoft.com/"
              className="bg-button-bg px-8 py-2.5 rounded-2xl text-[15.4px] mr-4"
              target="_blank"
            >
              Book A Demo
            </Link>
      ...
      <div className="bg-footer-bg h-[681px] flex flex-col justify-end">
        <div className="w-[1180px] flex gap-12 mx-auto">
          ...
          <div className="flex-[1] flex flex-col gap-8">
            <div className="flex flex-col gap-3">
              <p className="text-[20.71px] font-semibold">Email</p>
              <div className="relative before:absolute before:left-0 before:top-1/2 before:w-[34px] before:h-[3px] before:-bg-yellow mb-1"></div>
              <p className="text-[15.53px] font-normal">info@kaispe.com</p>
            </div>
            <div className="flex flex-col gap-3">
              <p className="text-[20.71px] font-semibold">Contact Number</p>
              <div className="relative before:absolute before:left-0 before:top-1/2 before:w-[34px] before:h-[3px] before:-bg-yellow mb-1"></div>
          ...
          <div className="flex-[1] flex flex-col gap-4">
            <p className="text-[20.71px] font-semibold">Address</p>
            <div className="relative before:absolute before:left-0 before:top-1/2 before:w-[34px] before:h-[3px] before:-bg-yellow mb-1"></div>
            <p className="text-[15.53px] font-normal">
